...
import MaterialVideoDrawer from './drawer.vue';
import {
  deleteMaterialApi,
  getMaterialListApi,
  updateMaterialApi,
...
const gridOptions: VxeGridProps = {
  ...
  columns: [
    ...
    {
      title: $t('page.material.video.name'),
      field: 'name',
    },
    {
      title: $t('page.material.video.resource'),
      field: 'resource',
      slots: { default: 'resource' },
    },
    {
      title: $t('page.material.video.description'),
      field: 'description',
    },
    {
...
const [Drawer, drawerApi] = useVbenDrawer({
  connectedComponent: MaterialVideoDrawer,
  onClosed() {
...
<template>
  <Page auto-content-height>
    <Grid :table-title="$t('page.material.video.title')">
      <template #toolbar-tools>
        <el-button
          class="mr-2"
          v-permission="['system:material:video:create']"
          type="primary"
          @click="handleCreate"
        >
          {{ $t('page.material.video.button.create') }}
        </el-button>
      </template>
      ...
      <template #status="{ row }">
        <el-switch
          ...
          :disabled="!hasPermission(['system:material:video:update'])"
        />
      </template>
      ...
      <template #action="{ row }">
        <ElButton
          type="primary"
          link
          v-permission="['system:material:video:update']"
        ...
        <el-popconfirm
          :title="
            $t('ui.text.do_you_want_delete', {
              moduleName: $t('page.material.video.module'),
            })
          "
        ...
        >
          <template #reference>
            <ElButton
              type="danger"
              v-permission="['system:material:video:delete']"
              link
              :icon="LucideTrash2"
            />
          </template>
