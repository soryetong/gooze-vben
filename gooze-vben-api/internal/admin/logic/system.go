...
// @Summary ApiList
func (self *SystemLogic) ApiList(ctx context.Context, params *dto.ApiListReq) (resp *dto.CommonListResp, err error) {
...
// @Summary DictList
func (self *SystemLogic) DictList(ctx context.Context, params *dto.DictListReq) (resp *dto.CommonListResp, err error) {
	resp = &dto.CommonListResp{}
...
// @Summary MenuRouter
func (self *SystemLogic) MenuRouter(ctx context.Context) (resp *dto.CommonListResp, err error) {
	var authIds []int64
...
// @Summary MenuTree
func (self *SystemLogic) MenuTree(ctx context.Context, params *dto.MenuTreeReq) (resp *dto.CommonListResp, err error) {
...
// @Summary RecordList
func (self *SystemLogic) RecordList(ctx context.Context, params *dto.RecordListReq) (resp *dto.CommonListResp, err error) {
	resp = &dto.CommonListResp{}
...
// @Summary RoleList
func (self *SystemLogic) RoleList(ctx context.Context, params *dto.RoleListReq) (resp *dto.CommonListResp, err error) {
	resp = &dto.CommonListResp{}
...
func (self *SystemLogic) RoleAssign(ctx context.Context, id int64, params *dto.AssignRoleReq) (err error) {
	var casbinInfos []gzauth.CasbinInfo
	err = gooze.Gorm().Transaction(func(tx *gorm.DB) error {
		...
		for _, api := range apis {
			...
			if api.Path != "" {
				casbinInfos = append(casbinInfos, gzauth.CasbinInfo{
					Path:   api.Path,
					Method: api.Method,
				})
			}
	...
	if err == nil {
		err = gzauth.UpsertCasbin(ctx, gooze.Casbin, id, casbinInfos)
	}
...
// @Summary UserList
func (self *SystemLogic) UserList(ctx context.Context, params *dto.UserListReq) (resp *dto.CommonListResp, err error) {
	resp = &dto.CommonListResp{}
